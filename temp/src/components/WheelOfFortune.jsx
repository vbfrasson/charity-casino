...
export class WheelOfFortune extends React.Component {
    jQueryCode = () => {
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 730 730">
                                    <g class="wheel">
                                        ...
                                        <g class="sectors">
                                            ...
                                            <text fill="white" x="242" y="242" font-size="60" text-anchor="middle" transform="rotate(220,242,242)" alignment-baseline="central">1 🍔</text>
                                            <text fill="white" x="320" y="197" font-size="60" text-anchor="middle" transform="rotate(250,320,197)" alignment-baseline="central">2 😀</text>
                                            <text fill="white" x="409" y="197" font-size="60" text-anchor="middle" transform="rotate(-68,409,197)" alignment-baseline="central">3 🎂</text>    
                                            <text fill="white" x="487" y="242" font-size="55" text-anchor="middle" transform="rotate(-45,487,242)" alignment-baseline="central">4 😔</text>
                                            <text fill="white" x="532.8" y="320" font-size="60" text-anchor="middle" transform="rotate(-13,532.8,320)" alignment-baseline="central">5 🎂</text>
                                            <text fill="white" x="532" y="409" font-size="60" text-anchor="middle" transform="rotate(27,532,409)" alignment-baseline="central">6 😀</text>
                                            <text fill="white" x="487" y="487" font-size="60" text-anchor="middle" transform="rotate(36,487,487)" alignment-baseline="central">7 🎂</text>
                                            <text fill="white" x="409.9" y="532.8" font-size="60" text-anchor="middle" transform="rotate(70,409,532)" alignment-baseline="central">8 😔</text>
                                            <text fill="white" x="320" y="520" font-size="60" text-anchor="middle" transform="rotate(105,320,520)" alignment-baseline="central">9 🍔</text>
                                            <text fill="white" x="242" y="487" font-size="60" text-anchor="middle" transform="rotate(130,242,487)" alignment-baseline="central">10 🎂</text>
                                            <text fill="white" x="197" y="409" font-size="60" text-anchor="middle" transform="rotate(170,197,409)" alignment-baseline="central">11 😀</text>
                                            <text fill="white" x="197" y="320" font-size="60" text-anchor="middle" transform="rotate(198,197,320)" alignment-baseline="central">12 😔</text>
                                        </g>
                                        <g class="middle">
                    ...
                    <div class="container">
                        <div class="row buttons">
                            <div class="col-xs-6 col-lg-6 col-md-6">
                                <button id="btnPlay" class="btn btn-primary">Spin!</button>
                            </div>
                            <div class="col-xs-6 col-lg-6 col-md-6">
                                <button id="btnSlowMo" class="btn btn-primary">Slow Spin</button>
                            </div>
                        </div>
                    </div>
                </div>
